...
namespace UYVY8bit
{
	...
	void to_v210(const uint8_t *sourceUYVY8bits, uint8_t *targetV210, int32_t width, int32_t height)
	{
...
#define B8_to_B10(x)      \
	...
	static void to_UYVY10bitBytePacking(const uint8_t *sourceUYVY8bits, uint8_t *targetUYVY10bitBytePacking, int32_t w, int32_t h)
	{
		const unsigned char *src = (unsigned char *)sourceUYVY8bits;
